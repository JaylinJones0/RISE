...
function Heading() {
  return (
    <motion.div  initial={{ opacity: 0, y: 20 }}
        ...
        transition={{ duration: 0.8, delay: 0.2}}className="content-stretch flex flex-col items-center relative shrink-0" data-name="Heading">
...
function ListWhyUs() {
  return (
    <div
      className="content-stretch flex flex-col md:flex-row gap-[50px] items-start w-full"
      data-name="List Why Us"
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.4}}
        className="md:w-[492px] w-full h-[586px] relative rounded-[16px] shrink-0"
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[16px]">
          <img
            alt=""
            className="absolute h-full left-[-9.59%] max-w-none top-[0.00%] w-[119.11%] object-cover"
            src={imgRectangle695}
          />
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="w-full md:w-[688px] font-['Sora:Regular',sans-serif] font-normal text-[#132334] text-[18px] leading-[32px] whitespace-pre-wrap"
      >
        <p className="[word-break:break-word] capitalize font-['Sora:SemiBold',sans-serif] font-semibold leading-[45px] relative shrink-0 text-[#1b2260] text-[35px] text-left tracking-[-1.px] whitespace-nowrap">
          Pamala Burch
        </p>
